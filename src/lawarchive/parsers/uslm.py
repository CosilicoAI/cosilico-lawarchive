...
from lawarchive.models import Section, Subsection, Citation
...
class USLMParser:
    ...
    def get_title_number(self) -> int:
        ...
        # Title number is in the identifier attribute
    ...
    def get_title_name(self) -> str:
        ...
        root = self.tree.getroot()
        heading = root.find(".//uslm:title/uslm:heading", USLM_NS)
    ...
    def iter_sections(self) -> Iterator[Section]:
        ...
        for section_elem in root.iter("{http://schemas.gpo.gov/xml/uslm}section"):
            try:
    ...
    def get_section(self, section_num: str) -> Optional[Section]:
    ...
    def _parse_subsections(self, parent: etree._Element) -> list[Subsection]:
        ...
        for tag in subsection_tags:
            for sub_elem in parent.findall(f"uslm:{tag}", USLM_NS):
                ...
                heading_elem = sub_elem.find("uslm:heading", USLM_NS)
    ...
    def _get_direct_text(self, elem: etree._Element) -> str:
        ...
        for child in elem:
            ...
            elif tag not in ["subsection", "paragraph", "subparagraph", "clause", "subclause"]:
    ...
    def _extract_references(self, elem: etree._Element) -> list[str]:
        ...
        for ref in elem.iter("{http://schemas.gpo.gov/xml/uslm}ref"):
            href = ref.get("href", "")
