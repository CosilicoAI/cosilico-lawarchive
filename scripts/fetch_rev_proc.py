#!/usr/bin/env python3
"""Fetch and store IRS Revenue Procedures in the lawarchive database.

This script downloads Rev. Procs from IRS.gov and stores them in the lawarchive
...
from lawarchive.fetchers.irs_guidance import IRSGuidanceFetcher
from lawarchive.storage.guidance import GuidanceStorage


def fetch_and_store_rev_proc(doc_number: str, db_path: str = "lawarchive.db") -> None:
